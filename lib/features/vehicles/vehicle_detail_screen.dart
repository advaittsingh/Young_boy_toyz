...
class VehicleDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final csvVehicleService = CsvVehicleService();

    return FutureBuilder<List<Vehicle>>(
      future: csvVehicleService.loadVehiclesFromCsv('assets/YBTCarList.csv'),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Center(child: CircularProgressIndicator());
        } else if (snapshot.hasError) {
          return Center(child: Text('Error loading vehicle data: \${snapshot.error}'));
        ...
        return Scaffold(
          ...
          body: ListView(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Car Insurance', style: TextStyle(fontWeight: FontTheme.textWhite)),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
                child: const Text('Similar Cars', style: TextStyle(fontWeight: FontTheme.textWhite, fontSize: 18, color: AppTheme.textWhite)),
              ),
              SizedBox(
                height: 220,
